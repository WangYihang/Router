...
def forwarding_server(listen_host, listen_port, remote_host, remote_port, max_connection):
    global data_recoder
...
def main():
    ...
    MAX_CONNECTION = 0x10
    forwarding_server(LOCAL_HOST, LOCAL_PORT, REMOTE_HOST, REMOTE_PORT, MAX_CONNECTION)
